rule fake_calibrate:
    input:
        bam = "result/{BaseName}/{CalibrateParentDir}/{BaseName}.bam",
        bai = "result/{BaseName}/{CalibrateParentDir}/{BaseName}.bam.bai"
    output:
        bam = "result/{BaseName}/{CalibrateParentDir}/no-calibrate/{BaseName}.bam",
        bai = "result/{BaseName}/{CalibrateParentDir}/no-calibrate/{BaseName}.bam.bai"
    threads: 1
    run:
