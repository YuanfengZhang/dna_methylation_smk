rule fake_pre_dedup:
    input:
        r1 = "result/{BaseName}/{PreDedupParentDir}/{BaseName}.R1.fq.gz",
        r2 = "result/{BaseName}/{PreDedupParentDir}/{BaseName}.R2.fq.gz"
    output:
        r1 = "result/{BaseName}/{PreDedupParentDir}/no-pre-dedup/{BaseName}.R1.fq.gz",
        r2 = "result/{BaseName}/{PreDedupParentDir}/no-pre-dedup/{BaseName}.R2.fq.gz"
    threads: 1
    run:
