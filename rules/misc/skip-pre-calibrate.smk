rule fake_pre_calibrate:
    input:
        r1 = "result/{BaseName}/{PreCalibrateParentDir}/{BaseName}.R1.fq.gz",
        r2 = "result/{BaseName}/{PreCalibrateParentDir}/{BaseName}.R2.fq.gz"
    output:
        r1 = "result/{BaseName}/{PreCalibrateParentDir}/no-pre-calibrate/{BaseName}.R1.fq.gz",
        r2 = "result/{BaseName}/{PreCalibrateParentDir}/no-pre-calibrate/{BaseName}.R2.fq.gz"
    threads: 1
    run:
